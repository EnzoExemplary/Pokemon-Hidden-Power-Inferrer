...
public class TypeMatchUps {
    private static final Damage[] NORMAL = {
        ...
        new Damage(Type.ROCK, .5),     new Damage(Type.GHOST, 0),     new Damage(Type.DRAGON, 1),      new Damage(Type.DARK, 1),
    ...
    private static final Damage[] WATER = {
        ...
        new Damage(Type.ROCK, 2),      new Damage(Type.GHOST, 1),     new Damage(Type.DRAGON, .5),     new Damage(Type.DARK, 1),
    ...
    private static final Damage[] ELECTRIC = {
        ...
        new Damage(Type.ROCK, 1),      new Damage(Type.GHOST, 1),     new Damage(Type.DRAGON, .5),     new Damage(Type.DARK, 1),
        new Damage(Type.STEEL, 1),     new Damage(Type.FAIRY, 1)
    };
    ...
    private static final Damage[] FIGHTING = {
        ...
        new Damage(Type.ROCK, 2),      new Damage(Type.GHOST, 0),     new Damage(Type.DRAGON, 1),      new Damage(Type.DARK, 2),
    ...
    private static final Damage[] PSYCHIC = {
        ...
        new Damage(Type.ROCK, 1),      new Damage(Type.GHOST, 1),     new Damage(Type.DRAGON, 1),      new Damage(Type.DARK, 0),
        new Damage(Type.STEEL, .5),    new Damage(Type.FAIRY, 1)
    };
    ...
    private static final Damage[] BUG = {
        ...
        new Damage(Type.ROCK, 1),      new Damage(Type.GHOST, .5),    new Damage(Type.DRAGON, 2),      new Damage(Type.DARK, 1),
    ...
    private static final Damage[] GHOST = {
        ...
        new Damage(Type.ROCK, 1),      new Damage(Type.GHOST, 2),     new Damage(Type.DRAGON, 1),      new Damage(Type.DARK, .5),
        new Damage(Type.STEEL, 1),     new Damage(Type.FAIRY, 1)
    };
    ...
    private static final Damage[] FAIRY = {
        ...
        new Damage(Type.GROUND, 1),    new Damage(Type.FLYING, 1),    new Damage(Type.PSYCHIC, 1),     new Damage(Type.BUG, 1),
        new Damage(Type.ROCK, 1),      new Damage(Type.GHOST, 1),     new Damage(Type.DRAGON, 2),      new Damage(Type.DARK, 2),
        new Damage(Type.STEEL, .5),    new Damage(Type.FAIRY, 1)
    };
}